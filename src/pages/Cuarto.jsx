  ...
  return (
    <>
      ...
      <ul className="list-disc pl-5">
        <li>
          Es un Hook que permite encapsular lógica reutilizable y que puede ser
          utilizado en cualquier componente.
        </li>
      </ul>
      ...
      <div className="flex justify-center gap-6 mb-8 mt-8 flex-wrap">
        ...
        <div className="border rounded-lg p-4 w-64 text-center shadow">
          ...
          <button className="btn btn-success mx-1" onClick={getPokemon}>
            Obtener Pokémon
          </button>
        </div>
        ...
        <div className="border rounded-lg p-4 w-64 text-center shadow">
          ...
          {clima ? (
            <>
              ...
              <p className="mb-2">
                Código clima: {clima.current_weather.weathercode}
              </p>
            </>
          ) : (
            <p className="text-gray-400 mb-4">Sin datos aún</p>
          )}
          <button className="btn btn-success mx-1" onClick={getClima}>
            Obtener Clima
          </button>
        </div>
      </div>
